...
const headCells = [
  ...
  { id: 'Tip Label', label: 'Tip Content' },
  { id: 'View', label: '' },
  { id: 'Disable', label: '' },
];
...
export default function EnhancedTable() {
  ...
  return (
    <Applayout>
     <Button
        variant="contained"
        style={{ backgroundColor: '#fbbb35', width: '20%', height: '50px', marginTop: '5%',}}
        href="/tipsform"
      >
        Add New
      </Button>
      <Button variant="contained" style={{ backgroundColor: '#d3d3d3', width: '20%', height: '50px', marginTop: '5%',marginLeft: '4%',}}>
        Disable
      </Button>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right"> <EditIcon style={{ color: '#FA2222' }} /></TableCell>
